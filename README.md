...
This project is based off from kitpit's django-sample app tutorial found at https://github.com/kirpit/django-sample-app.  I am simply adding the extra step of hosting it using AWS ElasticBeanstalk and using AWS CodePipeline.
